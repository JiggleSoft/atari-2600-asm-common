...
set SRC_DIR=..\..\src\test\stdx\asm
set INC_DIR=..\..\src\test\stdx\asminc
...
C:\opt\cc65\bin\ca65.exe -D PLATFORM_PAL=1 -I %CC65_HOME%\asminc -I %STD_INC_DIR% -I %STDX_INC_DIR% -I %STDX_INC_TODO_DIR% -I %INC_DIR% --cpu 6502 -t atari2600 -l %BUILD_DIR%\%APP_NAME_PAL%.lst %SRC_DIR%\%APP_NAME%.asm -o %BUILD_DIR%\%APP_NAME_PAL%.o
...
C:\opt\cc65\bin\ca65.exe -D PLATFORM_NTSC=1 -I %CC65_HOME%\asminc -I %STD_INC_DIR% -I %STDX_INC_DIR% -I %STDX_INC_TODO_DIR% -I %INC_DIR% --cpu 6502 -t atari2600 -l %BUILD_DIR%\%APP_NAME_NTSC%.lst %SRC_DIR%\%APP_NAME%.asm -o %BUILD_DIR%\%APP_NAME_NTSC%.o
...
C:\opt\cc65\bin\ca65.exe -D PLATFORM_SECAM=1 -I %CC65_HOME%\asminc -I %STD_INC_DIR% -I %STDX_INC_DIR% -I %STDX_INC_TODO_DIR% 	-I %INC_DIR% --cpu 6502 -t atari2600 -l %BUILD_DIR%\%APP_NAME_SECAM%.lst %SRC_DIR%\%APP_NAME%.asm -o %BUILD_DIR%\%APP_NAME_SECAM%.o
