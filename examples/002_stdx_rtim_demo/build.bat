...
C:\opt\cc65\bin\ca65.exe -D PLATFORM_PAL=1 -I %CC65_INC_DIR% -I %STD_INC_DIR% -I %STDX_INC_DIR% -I %APP_INC_DIR% --cpu 6502 -t atari2600 -l %BUILD_DIR%\%APP_NAME_PAL%.lst %APP_SRC_DIR%\%APP_NAME%.asm -o %BUILD_DIR%\%APP_NAME_PAL%.o
...
C:\opt\cc65\bin\ca65.exe -D PLATFORM_NTSC=1 -I %CC65_INC_DIR% -I %STD_INC_DIR% -I %STDX_INC_DIR% -I %APP_INC_DIR% --cpu 6502 -t atari2600 -l %BUILD_DIR%\%APP_NAME_NTSC%.lst %APP_SRC_DIR%\%APP_NAME%.asm -o %BUILD_DIR%\%APP_NAME_NTSC%.o
...
C:\opt\cc65\bin\ca65.exe -D PLATFORM_SECAM=1 -I %CC65_INC_DIR% -I %STD_INC_DIR% -I %STDX_INC_DIR% -I %APP_INC_DIR% --cpu 6502 -t atari2600 -l %BUILD_DIR%\%APP_NAME_SECAM%.lst %APP_SRC_DIR%\%APP_NAME%.asm -o %BUILD_DIR%\%APP_NAME_SECAM%.o
